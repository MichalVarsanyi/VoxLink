...
set_property IOSTANDARD LVCMOS33 [get_ports {SERIAL_D[2]}]
set_property PACKAGE_PIN A1 [get_ports {SERIAL_D[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SERIAL_D[1]}]
set_property PACKAGE_PIN B1 [get_ports {SERIAL_D[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SERIAL_D[0]}]
