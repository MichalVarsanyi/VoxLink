...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../Spartan_UART_Readout_Testing.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Spartan_UART_Readout_Testing.gen/sources_1/ip/ila_0/hdl/verilog" \
