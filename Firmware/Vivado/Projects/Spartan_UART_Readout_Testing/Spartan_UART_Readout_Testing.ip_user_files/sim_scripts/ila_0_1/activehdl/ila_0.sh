...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/varsa/Desktop/School/5_semester/BachelorProject/VoxLink/Firmware/Vivado/Projects/Spartan_UART_Readout_Testing/Spartan_UART_Readout_Testing.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
