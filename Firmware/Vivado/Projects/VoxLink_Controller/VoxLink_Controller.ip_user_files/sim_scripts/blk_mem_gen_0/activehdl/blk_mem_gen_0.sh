...
#
# Script generated by Vivado on Tue May 05 16:34:52 +0200 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/BachelorProject/VoxLink/Firmware/Vivado/Projects/VoxLink_Controller/VoxLink_Controller.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
